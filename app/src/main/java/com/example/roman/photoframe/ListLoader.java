...
public class ListLoader extends AsyncTaskLoader<List<ListItem>> {
    private static String TAG = "ListLoader";
    ...
    public ListLoader(Context context, Credentials credentials, String dir) {
        super(context);
        handler = new Handler();
